...
- Choosing manual entry doesn't take the search bar away (2026-08): it stays put, now rendered directly above the manual address form, so typing an address by hand and searching are both available at once — manual entry is a fork you can still search your way back out of, not a dead end of its own.
